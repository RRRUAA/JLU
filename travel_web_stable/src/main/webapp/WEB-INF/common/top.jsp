...
<div class="content">
	<div class="width1190">
		<form action="IndexServlet?action=toSearchIndex" method="post" class="pro-search">
			<table>
				...
				<tr>
					...
					<td>
						...
						<input type="number" class="protext" name="price2" value="${price2 }" style="width:40px;"/> 元
			...
			<div class="paixu">
				...
				<a href="IndexServlet?action=toSearchIndex&orderBy=1">价格 &or;</a>
