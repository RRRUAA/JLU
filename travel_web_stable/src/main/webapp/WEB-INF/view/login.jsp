...
<div class="login" style="height:500px;">
	<form id="saveForm">
		...
		<div class="form-group">
			<label>密码</label>
			<input type="password" v-model="password" name="password" id="password" class="form-control form-control-lg"
				   id="pwd">
		</div>
		<div class="form-group form-check">
			...
			<input type="radio" class="form-check-input" name="type" value="2" id="exampleCheck1" checked>
			<label class="form-check-label" for="exampleCheck1">游客</label>
		...
		<button type="button" onclick="location.href='IndexServlet?action=toIndex'"
