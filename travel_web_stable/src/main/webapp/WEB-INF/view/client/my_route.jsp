...
<div class="content">
	<div class="width1190">
		...
		<div class="vip-right">
			<h3 class="vipright-title">我发布的旅游路线</h3>
			<ul class="guanzhueq">
				<li class="guanzhueqcur"><a href="javascript:;">旅游路线列表</a></li>

				<div class="clearfix"></div>
			</ul><!--guanzhueq/-->
			<div class="guanzhulist">
				<c:forEach items="${routes }" var="data">
					<dl>
						<dt><a href=""><img src="upload/${data.user.photo}" width="80" height="120"/></a></dt>
						<dd>
								<%--   <h3><a href="HouseServlet?action=detail&id=${g.house.id }">${g.house.title }</a></h3> --%>
							<div class="guantext">路线编号：${data.route_no}</div>
							<div class="guantext"></div>
							<div class="guantext">评论内容：${data.note}</div>
