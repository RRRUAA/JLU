...
<jsp:include page="/WEB-INF/common/situation_top.jsp"/>
...
<div class="width1190">
	...
	<div class="pro-left">
		<c:forEach items="${list}" var="data">
			<dl>
				<dt><a href="IndexServlet?action=toSituation&id=${data.id }"><img src="upload/${data.scenic.photo }"
																			   width="286" height="128"/></a></dt>
				<dd>
					<h3>景点：<a href="IndexServlet?action=toSituation&id=${data.id }">${data.scenic.names}</a></h3>
						<%--  <div class="pro-wei">
					...
					<div class="pra-fang">景点人数：<strong style="color:red">${data.queuenum }人</strong></div>
				</dd>
