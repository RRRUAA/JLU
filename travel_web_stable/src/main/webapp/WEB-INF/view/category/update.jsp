			...
			<main>
				<div class="main">
							...
							<div class="col-5">
								<form id="saveForm">
									...
									<div class="form-group">
										<label>标签名称</label> <input type="text" name="cname" value="${data.cname }"
					...
					<div class="submit-box">
						...
						<a type="button" href="CategoryServlet?action=CategoryList"
    ...
    $("#save").click(function () {
        $.ajax({
            ...
            success: function (e) {
                if (e == 'yes') {
                    alert("修改成功！");
                    window.parent.location.href = "CategoryServlet?action=CategoryList";
                } else {
                    alert("修改失败！");
                }
            }
