			...
			<main>
				<div class="main">
					<div class="search">
						...
						<!-- <a class="btn btn-primary float-right" href="Category_create.html"><i
								...
								<tr>
									...
									<td>
										...
										<a class="btn btn-primary btn-sm"
										   href="CategoryServlet?action=toUpdateCategory&id=${data.id }">修改</a> <a
					...
					<div class="page">
						<ul class="pagination">
							<li class="page-item"><a class="page-link"
													 href="CategoryServlet?action=CategoryList&p=1">首页</a></li>
							<c:if test="${cp>1}">
								<li class="page-item"><a class="page-link"
							...
							<li class="page-item"><a class="page-link"
													 href="CategoryServlet?action=CategoryList&p=${tp}">尾页</a></li>
						</ul>
