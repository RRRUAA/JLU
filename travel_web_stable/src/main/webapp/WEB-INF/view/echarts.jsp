...
<div id="app" class="d-flex">
	...
	<main>
		...
		<div id="body">
			...
			<script src="<%=path%>/resource/static/echarts/echarts.min.js"></script>
			<script src="<%=path%>/resource/static/js/jquery-3.3.1.min.js"></script>
			...
			<script type="text/javascript">
                ...
                $.ajax({
                    cache: true,
                    type: "post",
                    url: "OrdersServlet?action=selectStaticsOrders",
                    async: false,
                    success: function (e) {
                        if (e) {
                            var list = eval(e);
                ...
                $.ajax({
                    cache: true,
                    type: "post",
                    url: "CommentsServlet?action=selectStaticsComments",
                    async: false,
                    success: function (e) {
                        if (e) {
                            var list = eval(e);
